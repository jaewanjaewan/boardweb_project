...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> <%--jstl쓸려면 꼭 포함!--%>
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"> <%--폰트를 사용하기위해서 css파일 추가--%>
